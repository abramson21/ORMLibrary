namespace Infrastructure.Helpers
{
    ...
    {
        public static string DataSourceLocation = @"Data Source=DESKTOP-V49F727\SQLEXPRESS";

        private static string GetConnectionString() => @"Data Source=DESKTOP-V49F727\SQLEXPRESS;Initial Catalog=DBLibraryHome;Integrated Security=True";
